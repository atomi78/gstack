...
Use the `/browse` skill from gstack for all web browsing and site interaction. Never use `mcp__claude-in-chrome__*` tools — they are slow, unreliable, and not what this project uses.
